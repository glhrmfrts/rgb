...
class MenuScene(Scene):
	...
	def __init__(self, game, start_level):
		...
		self.texts.append(Text(small_font, "1 - Red", (game.width / 2, 250), RED))
		self.texts.append(Text(small_font, "2 - Green", (game.width / 2, 300), GREEN))
		self.texts.append(Text(small_font, "3 - Blue", (game.width / 2, 350), BLUE))

		self.texts.append(Text(small_font, "You don't collide with anything", (game.width / 2, 400)))
		self.texts.append(Text(small_font, "that has the same color as you", (game.width / 2, 420)))
